...
Computer Science graduate (University of Washington Tacoma) working on ocean and environmental data: CTD profiles, satellite imagery, drone photogrammetry and computer vision for biodiversity monitoring.
US Army veteran. Looking for entry-level data science or research software roles in ocean and environmental science.
...
| [CTD_Grapher](https://github.com/jimothy-dev/CTD_Grapher) | First version of the CTD grapher (Excel + Google Drive workflow) written for a UW Tacoma estuarine field course. Superseded by v2. |

## Skills

**Languages** — Python, R, Java, SQL, JavaScript

**ML & CV** — PyTorch, Hugging Face Transformers, Segment Anything (SAM 3 / SAM 2.1), BioCLIP / CLIP-style zero-shot classification, DESeq2 and Bioconductor, NumPy, pandas, SciPy

**Geospatial & ocean data** — Google Earth Engine (Sentinel-2, Landsat 8/9), GeoTIFF, Sea-Bird CTD `.cnv` processing, photogrammetry, UTM / WGS 84 coordinate systems, Three.js 3D visualisation

**Tools** — Git and GitHub (Pages, CLI), Google Colab, Jupyter and JupyterHub, FastAPI, Plotly, Matplotlib, ggplot2, Linux and Windows, CUDA GPUs

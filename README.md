...
Computer Science graduate (University of Washington Tacoma) working on ocean and environmental data: CTD profiles, satellite imagery, and computer vision for biodiversity monitoring.
...
**Ocean data** — Sea-Bird CTD `.cnv` processing, photogrammetry

**Tools** — Git and GitHub (Pages, CLI), Google Colab, Jupyter and JupyterHub, FastAPI, Plotly, Matplotlib, ggplot2, Linux and Windows
